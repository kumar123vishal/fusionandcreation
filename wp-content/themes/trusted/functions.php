...
function trusted_editor_fonts_url() {
	...
	if ( 'off' !== _x( 'on', 'Google fonts: on or off', 'trusted' ) ) {
		...
		$fonts[] = get_theme_mod( 'font_page_title', 'Ubuntu:300,300italic,regular,italic,500,500italic,700,700italic' );
		$fonts[] = get_theme_mod( 'font_content', 'Open Sans:300,400,600,700,800' );
		$fonts[] = get_theme_mod( 'font_headings', 'Montserrat:400,700' );
...
function trusted_scripts() {
	...
	wp_enqueue_style( 'trusted-font-awesome', get_template_directory_uri() . '/css/font-awesome.min.css' );
 ...
 */
function trusted_enqueue_gutenberg_block_editor_assets() {
	wp_enqueue_style( 'trusted-block-editor-fonts', trusted_editor_fonts_url() );
	wp_enqueue_style( 'trusted-block-editor-style', get_template_directory_uri() . '/css/block-editor-style.css' );
	wp_add_inline_style( 'trusted-block-editor-style', trusted_block_editor_dynamic_style() );
}
add_action( 'enqueue_block_editor_assets', 'trusted_enqueue_gutenberg_block_editor_assets' );
