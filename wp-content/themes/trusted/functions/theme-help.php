	...
	<div class="wrap theme-help-wrap">
		...
		<div class="important-links clearfix">
			<p><strong><?php esc_html_e( 'Theme Links', 'trusted' ); ?>:</strong>
				...
				<a href="<?php echo esc_url( 'https://uxlthemes.com/docs/trusted-theme/' ); ?>" target="_blank"><?php esc_html_e( 'Theme Documentation', 'trusted' ); ?></a>
				<a href="<?php echo esc_url( 'https://uxlthemes.com/forums/forum/trusted/' ); ?>" target="_blank"><?php esc_html_e( 'Theme Support', 'trusted' ); ?></a>
				<a href="<?php echo esc_url( 'https://wordpress.org/support/theme/trusted/reviews/?filter=5' ); ?>" target="_blank"><?php esc_html_e( 'Rate this theme', 'trusted' ); ?></a>
			</p>
		</div>
		<hr>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( 'https://uxlthemes.com/docs/trusted-theme/' ); ?>" target="_blank" class="button button-secondary">
